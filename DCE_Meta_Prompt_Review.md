# DCE Meta Prompt — Standalone Review Document

> Extracted from `src/components/flow/DeliverableCreatorStep.jsx` (lines 272-828)
> and `server/src/routes/deliverable.js` (lines 35-69)
>
> This document contains the two meta prompts that generate the step-by-step
> chunks for DCE output. The Executive mode prompt (Section 1) generates 8
> self-contained copy-paste prompts. The Working mode prompt (Section 2)
> generates 3-7 dynamic chunks.

---

## Section 1: Executive DCE Meta Prompt

*Source: `src/components/flow/DeliverableCreatorStep.jsx:272-828`*
*Called client-side via `InvokeLLM()` with JSON schema enforcement*
...
## Section 2: Working Mode System Prompt

*Source: `server/src/routes/deliverable.js:35-69`*
*Sent as Anthropic API `system` parameter with streaming SSE response*

---

```
WORKING DELIVERABLE MODE — DYNAMIC CHUNK GENERATION
...
### Working Mode User Prompt Template

*Source: `server/src/routes/deliverable.js:151-164`*
